...
const mockTools: ToolItem[] = [
  ...
  },
  {
    id: 2,
    name: "order_query",
    triggerKey: "toolTriggerOrder",
    inputKey: "toolInputOrderId",
    outputKey: "toolOutputOrderInfo",
    status: "enabled",
    implemented: false,
  },
  {
    ...
    triggerKey: "toolTriggerBusiness",
    inputKey: "toolInputAction",
    outputKey: "toolOutputResult",
    status: "enabled",
    implemented: false,
  },
  {
